import {
  ...
  class BggPage {
    ...
    headerLogo: By = By.css('.menu-logo-symbol')
    searchBar: By = By.css('.form-control rounded-lg')
    gamePageName: By = By.xpath('//a[@class = "ng-binding"]')
    gamePageRating: By = By.xpath('//span[@ng-show = "showRating"]')
